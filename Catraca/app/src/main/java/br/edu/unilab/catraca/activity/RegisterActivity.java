...
import br.edu.unilab.catraca.app.AppConfig;
import br.edu.unilab.catraca.app.AppController;
    ...
    private void registerUser(final String name, final String email,
        ...
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            public void onResponse(String response) {
                Log.d(TAG, "Cadastro obtido: " + response.toString());
                hideDialog();
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(), "Usuário cadastrado com êxito. Faça login agora!", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e(TAG, "Erro no cadastro: " + error.getMessage());
